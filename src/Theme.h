...
const char header_background_color[] PROGMEM = "background-color:rgba(82,80,71,0.8);";
const char header_text_color[] PROGMEM = "color:#cbc6af;";

const char footer_background_image[] PROGMEM = "background-image:none;";
const char footer_background_color[] PROGMEM = "background-color:rgba(82,80,71,0.6);";
