...
ESP8266OTA is a modified version of ESP8266HTTPUpdateServer customizable web UI.(Temporarily disable in v1.4.2 due incompatible with the new ESP8266 core library)    
